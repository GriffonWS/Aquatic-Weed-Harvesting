  ...
  form?.addEventListener('submit', (e) => {
    ...
    const done = (message, success) => {
      ...
      if (okMsg) {
        ...
        okMsg.hidden = false;
        okMsg.classList.toggle('form__ok--bad', !success);
      }
    };
    ...
    data.append('action', 'awh_quote');
    data.append('nonce', AWH.nonce);

    fetch(AWH.ajaxUrl, { method: 'POST', body: data, credentials: 'same-origin' })
